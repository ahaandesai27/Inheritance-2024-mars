...
recommender = RecipeRecommender(model, df = pd.read_csv('./recipes.csv'))
...
print("\nRecommendations:")
for recipe_id, recipe_name, score in recommendations:
    print(f"{recipe_id} {recipe_name}: {score:.4f}")
